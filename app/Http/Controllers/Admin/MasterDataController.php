    ...
    private function config(string $resource): array
    {
        $configs = [
            ...
            'siswa' => [
                ...
                'columns' => ['id_siswa' => 'ID', 'nama_siswa' => 'Nama Siswa', 'nis' => 'NIS', 'jk' => 'JK', 'no_hp' => 'No WA', 'kelas.nama_kelas' => 'Kelas'],
                'fields' => [
                    ...
                    ['name' => 'no_hp', 'label' => 'No WA', 'type' => 'text', 'help' => 'Gunakan nomor WhatsApp aktif, contoh: 081234567890.'],
                    ['name' => 'alamat', 'label' => 'Alamat', 'type' => 'textarea'],
