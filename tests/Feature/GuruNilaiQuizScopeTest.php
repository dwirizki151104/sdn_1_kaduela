...
class GuruNilaiQuizScopeTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_guru_only_sees_scores_from_their_own_quizzes(): void
    {
        [$guruUser, $ownQuiz, $otherQuiz] = $this->createQuizScoresForTwoTeachers();

        $this->actingAs($guruUser)
            ->get(route('admin.master.index', 'nilai-quiz'))
            ->assertOk()
    ...
    public function test_guru_without_quizzes_sees_empty_score_page(): void
    {
        $this->createQuizScoresForTwoTeachers();
        ...
        $this->actingAs($emptyGuruUser)
            ...
            ->assertDontSee('Quiz Guru Satu')
            ->assertDontSee('Quiz Guru Dua');
    }

    private function createQuizScoresForTwoTeachers(): array
    {
